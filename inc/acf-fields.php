...
add_action('acf/init', function () {
    ...
    acf_add_local_field_group([
        'key' => 'group_program_page',
        'title' => __('Program - Sections', 'yiari'),
        'location' => [[['param' => 'page_template', 'operator' => '==', 'value' => 'templates/program.php']]],
        'menu_order' => 13,
        'fields' => [
            ['key' => 'field_program_hero_tab', 'label' => __('Hero', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_hero_image', 'label' => __('Gambar Hero', 'yiari'), 'name' => 'program_hero_image', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_program_hero_title', 'label' => __('Judul Hero', 'yiari'), 'name' => 'program_hero_title', 'type' => 'textarea', 'rows' => 3, 'default_value' => __("Melindungi dan Mengembalikan Satwa\nLiar ke Habitatnya", 'yiari')],
            ['key' => 'field_program_hero_text', 'label' => __('Teks Hero', 'yiari'), 'name' => 'program_hero_text', 'type' => 'textarea', 'rows' => 4, 'default_value' => __('Dari penyelamatan darurat hingga rehabilitasi intensif, kami memastikan setiap satwa mendapatkan perawatan terbaik dan kesempatan kedua untuk hidup bebas di alam liar.', 'yiari')],
            ['key' => 'field_program_hero_btn_text', 'label' => __('Tombol 1 - Teks', 'yiari'), 'name' => 'program_hero_btn_text', 'type' => 'text', 'default_value' => __('Lihat Fokus Program', 'yiari')],
            ['key' => 'field_program_hero_btn_url', 'label' => __('URL Tombol Hero', 'yiari'), 'name' => 'program_hero_btn_url', 'type' => 'url'],
            ['key' => 'field_program_hero_btn2_text', 'label' => __('Tombol 2 - Teks', 'yiari'), 'name' => 'program_hero_btn2_text', 'type' => 'text', 'default_value' => __('Pelajari Lebih Lanjut', 'yiari')],
            ['key' => 'field_program_hero_btn2_url', 'label' => __('Tombol 2 - URL', 'yiari'), 'name' => 'program_hero_btn2_url', 'type' => 'url'],

            ['key' => 'field_program_action_tab', 'label' => __('Kenapa Penting', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_main_label', 'label' => __('Label Atas', 'yiari'), 'name' => 'program_main_label', 'type' => 'text', 'default_value' => __('KRISIS EKOSISTEM', 'yiari')],
            ['key' => 'field_program_main_title', 'label' => __('Judul Section', 'yiari'), 'name' => 'program_main_title', 'type' => 'textarea', 'rows' => 3, 'default_value' => __("Kenapa Ini Penting dan\nBagaimana Kami\nBertindak", 'yiari')],
            ['key' => 'field_program_main_desc', 'label' => __('Deskripsi Kanan', 'yiari'), 'name' => 'program_main_desc', 'type' => 'textarea', 'rows' => 4, 'default_value' => __('Perdagangan ilegal, konflik manusia-satwa, dan kerusakan habitat terus mengancam kehidupan satwa liar. Melalui penyelamatan, rehabilitasi, hingga pelepasliaran, kami membantu mereka mendapatkan kesempatan hidup yang lebih aman di alam.', 'yiari')],
            ['key' => 'field_program_main_image_main', 'label' => __('Gambar Utama Section', 'yiari'), 'name' => 'program_main_image_main', 'type' => 'image', 'return_format' => 'array'],
            [
                'key' => 'field_program_main_items',
                'label' => __('Daftar Tindakan', 'yiari'),
                'name' => 'program_main_items',
                'type' => 'repeater',
                'min' => 1,
                'max' => 6,
                'layout' => 'row',
                'button_label' => __('Tambah Tindakan', 'yiari'),
                'sub_fields' => [
                    ['key' => 'field_program_main_title_item', 'label' => __('Judul', 'yiari'), 'name' => 'title', 'type' => 'text'],
                    ['key' => 'field_program_main_details', 'label' => __('Deskripsi', 'yiari'), 'name' => 'details', 'type' => 'textarea', 'rows' => 3],
                ],
            ],

            ['key' => 'field_program_stats_tab', 'label' => __('Data & Bukti', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_stats_label', 'label' => __('Label Atas', 'yiari'), 'name' => 'program_stats_label', 'type' => 'text', 'default_value' => __('DATA & BUKTI', 'yiari')],
            ['key' => 'field_program_stats_title', 'label' => __('Judul Section', 'yiari'), 'name' => 'program_stats_title', 'type' => 'textarea', 'rows' => 2, 'default_value' => __('Dampak yang Terukur', 'yiari')],
            ['key' => 'field_program_stats_desc', 'label' => __('Deskripsi', 'yiari'), 'name' => 'program_stats_desc', 'type' => 'textarea', 'rows' => 3, 'default_value' => __('Setiap angka di bawah ini mewakili satwa yang diselamatkan, kehidupan yang diselamatkan, dan ekosistem yang dilindungi.', 'yiari')],
            [
                'key' => 'field_program_stats_items',
                'label' => __('Item Statistik', 'yiari'),
                'name' => 'program_stats_items',
                'type' => 'repeater',
                'min' => 1,
                'max' => 8,
                'layout' => 'table',
                'button_label' => __('Tambah Statistik', 'yiari'),
                'sub_fields' => [
                    ['key' => 'field_program_stat_number', 'label' => __('Angka', 'yiari'), 'name' => 'number', 'type' => 'number', 'column_width' => 20],
                    ['key' => 'field_program_stat_suffix', 'label' => __('Suffix', 'yiari'), 'name' => 'suffix', 'type' => 'text', 'column_width' => 10],
                    ['key' => 'field_program_stat_label', 'label' => __('Label', 'yiari'), 'name' => 'label', 'type' => 'text', 'column_width' => 50],
                    ['key' => 'field_program_stat_icon', 'label' => __('Nama Ikon Lucide', 'yiari'), 'name' => 'icon', 'type' => 'text', 'column_width' => 20, 'default_value' => 'badge-check'],
                ],
            ],

            ['key' => 'field_program_story_tab', 'label' => __('Dari Lapangan', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_story_label', 'label' => __('Label Atas', 'yiari'), 'name' => 'program_story_label', 'type' => 'text', 'default_value' => __('DARI LAPANGAN', 'yiari')],
            ['key' => 'field_program_story_title', 'label' => __('Judul Section', 'yiari'), 'name' => 'program_story_title', 'type' => 'textarea', 'rows' => 3, 'default_value' => __("Pulih Pasca Kena\nJeratan, Orangutan Siap\nKembali ke Habitatnya", 'yiari')],
            ['key' => 'field_program_story_desc', 'label' => __('Deskripsi', 'yiari'), 'name' => 'program_story_desc', 'type' => 'textarea', 'rows' => 4, 'default_value' => __('Setelah ditemukan terluka akibat jerat, orangutan ini menjalani perawatan intensif bersama tim YIARI hingga akhirnya dapat kembali hidup di alam liar.', 'yiari')],
            ['key' => 'field_program_story_btn1_text', 'label' => __('Tombol 1 - Teks', 'yiari'), 'name' => 'program_story_btn1_text', 'type' => 'text', 'default_value' => __('Baca Selengkapnya', 'yiari')],
            ['key' => 'field_program_story_btn1_url', 'label' => __('Tombol 1 - URL', 'yiari'), 'name' => 'program_story_btn1_url', 'type' => 'url'],
            ['key' => 'field_program_story_btn2_text', 'label' => __('Tombol 2 - Teks', 'yiari'), 'name' => 'program_story_btn2_text', 'type' => 'text', 'default_value' => __('Donasi Sekarang', 'yiari')],
            ['key' => 'field_program_story_btn2_url', 'label' => __('Tombol 2 - URL', 'yiari'), 'name' => 'program_story_btn2_url', 'type' => 'url'],
            ['key' => 'field_program_story_image', 'label' => __('Gambar Utama / Slide Pertama', 'yiari'), 'name' => 'program_story_image', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_program_story_gallery', 'label' => __('Gallery Carousel', 'yiari'), 'name' => 'program_story_gallery', 'type' => 'gallery', 'return_format' => 'array', 'preview_size' => 'medium', 'insert' => 'append', 'library' => 'all'],

            ['key' => 'field_program_focus_tab', 'label' => __('Area Fokus Program', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_focus_label', 'label' => __('Label Atas', 'yiari'), 'name' => 'program_focus_label', 'type' => 'text', 'default_value' => __('FOKUS PROGRAM', 'yiari')],
            ['key' => 'field_program_focus_title', 'label' => __('Judul Section', 'yiari'), 'name' => 'program_focus_title', 'type' => 'textarea', 'rows' => 3, 'default_value' => __("Area Fokus Program\nKami", 'yiari')],
            ['key' => 'field_program_focus_desc', 'label' => __('Deskripsi', 'yiari'), 'name' => 'program_focus_desc', 'type' => 'textarea', 'rows' => 4, 'default_value' => __('Setiap program memiliki fokus dan tantangan yang berbeda, mulai dari perlindungan satwa hingga pemberdayaan masyarakat dan pelestarian habitat.', 'yiari')],
            [
                'key' => 'field_program_focus_items',
                'label' => __('Kartu Fokus', 'yiari'),
                'name' => 'program_focus_items',
                'type' => 'repeater',
                'min' => 1,
                'max' => 6,
                'layout' => 'row',
                'button_label' => __('Tambah Kartu Fokus', 'yiari'),
                'sub_fields' => [
                    ['key' => 'field_program_focus_image', 'label' => __('Gambar', 'yiari'), 'name' => 'image', 'type' => 'image', 'return_format' => 'array'],
                    ['key' => 'field_program_focus_title_item', 'label' => __('Judul', 'yiari'), 'name' => 'title', 'type' => 'text'],
                    ['key' => 'field_program_focus_text', 'label' => __('Deskripsi', 'yiari'), 'name' => 'text', 'type' => 'textarea', 'rows' => 4],
                    ['key' => 'field_program_focus_link_text', 'label' => __('Teks Link', 'yiari'), 'name' => 'link_text', 'type' => 'text', 'default_value' => __('Lihat Selengkapnya', 'yiari')],
                    ['key' => 'field_program_focus_link_url', 'label' => __('URL Link', 'yiari'), 'name' => 'link_url', 'type' => 'url'],
                ],
            ],

            ['key' => 'field_program_cta_tab', 'label' => __('CTA Bawah', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_cta_label', 'label' => __('Label CTA', 'yiari'), 'name' => 'program_cta_label', 'type' => 'text', 'default_value' => __('DUKUNGAN ANDA', 'yiari')],
            ['key' => 'field_program_cta_title', 'label' => __('Judul CTA', 'yiari'), 'name' => 'program_cta_title', 'type' => 'textarea', 'rows' => 3, 'default_value' => __("Bantu Program\nKonservasi Menjangkau\nLebih Banyak Kehidupan", 'yiari')],
            ['key' => 'field_program_cta_text', 'label' => __('Teks CTA', 'yiari'), 'name' => 'program_cta_text', 'type' => 'textarea', 'rows' => 4, 'default_value' => __('Dukungan Anda membantu kami memperluas jangkauan program konservasi, memperkuat kolaborasi, dan menciptakan dampak yang lebih besar bagi satwa liar dan habitatnya.', 'yiari')],
            ['key' => 'field_program_cta_btn1_text', 'label' => __('Tombol 1 - Teks', 'yiari'), 'name' => 'program_cta_btn1_text', 'type' => 'text', 'default_value' => __('Donasi Sekarang', 'yiari')],
            ['key' => 'field_program_cta_btn1_url', 'label' => __('Tombol 1 - URL', 'yiari'), 'name' => 'program_cta_btn1_url', 'type' => 'url'],
            ['key' => 'field_program_cta_btn2_text', 'label' => __('Tombol 2 - Teks', 'yiari'), 'name' => 'program_cta_btn2_text', 'type' => 'text', 'default_value' => __('Gabung Bersama YIARI', 'yiari')],
            ['key' => 'field_program_cta_btn2_url', 'label' => __('Tombol 2 - URL', 'yiari'), 'name' => 'program_cta_btn2_url', 'type' => 'url'],
            ['key' => 'field_program_cta_image', 'label' => __('Gambar CTA', 'yiari'), 'name' => 'program_cta_image', 'type' => 'image', 'return_format' => 'array'],
        ],
    ]);
    ...
    acf_add_local_field_group([
        'key' => 'group_program_child_page',
        'title' => __('Program Child - Sections', 'yiari'),
        'location' => [[['param' => 'page_template', 'operator' => '==', 'value' => 'templates/program-child.php']]],
        'menu_order' => 19,
        'fields' => [
            ['key' => 'field_program_child_hero_tab', 'label' => __('Hero', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_child_hero_image', 'label' => __('Gambar Hero', 'yiari'), 'name' => 'program_child_hero_image', 'type' => 'image', 'return_format' => 'array'],
            ['key' => 'field_program_child_hero_title', 'label' => __('Judul Hero', 'yiari'), 'name' => 'program_child_hero_title', 'type' => 'textarea', 'rows' => 3],
            ['key' => 'field_program_child_hero_text', 'label' => __('Teks Hero', 'yiari'), 'name' => 'program_child_hero_text', 'type' => 'textarea', 'rows' => 4],
            ['key' => 'field_program_child_hero_btn1_text', 'label' => __('Tombol 1 - Teks', 'yiari'), 'name' => 'program_child_hero_btn1_text', 'type' => 'text', 'default_value' => __('Lihat Fokus Program', 'yiari')],
            ['key' => 'field_program_child_hero_btn1_url', 'label' => __('Tombol 1 - URL', 'yiari'), 'name' => 'program_child_hero_btn1_url', 'type' => 'url'],
            ['key' => 'field_program_child_hero_btn2_text', 'label' => __('Tombol 2 - Teks', 'yiari'), 'name' => 'program_child_hero_btn2_text', 'type' => 'text', 'default_value' => __('Pelajari Lebih Lanjut', 'yiari')],
            ['key' => 'field_program_child_hero_btn2_url', 'label' => __('Tombol 2 - URL', 'yiari'), 'name' => 'program_child_hero_btn2_url', 'type' => 'url'],

            ['key' => 'field_program_child_updates_tab', 'label' => __('Cerita Program', 'yiari'), 'name' => '', 'type' => 'tab', 'placement' => 'top'],
            ['key' => 'field_program_child_updates_label', 'label' => __('Label Section', 'yiari'), 'name' => 'program_child_updates_label', 'type' => 'text', 'default_value' => __('SOROTAN LAPANGAN', 'yiari')],
            ['key' => 'field_program_child_updates_title', 'label' => __('Judul Section', 'yiari'), 'name' => 'program_child_updates_title', 'type' => 'textarea', 'rows' => 3, 'default_value' => __("Cerita dan\nPerkembangan\nTerbaru", 'yiari')],
            ['key' => 'field_program_child_updates_desc', 'label' => __('Deskripsi Section', 'yiari'), 'name' => 'program_child_updates_desc', 'type' => 'textarea', 'rows' => 3, 'default_value' => __('Ikuti berbagai cerita, kegiatan, dan perkembangan terbaru dari program yang sedang berjalan di lapangan.', 'yiari')],
            ['key' => 'field_program_child_updates_categories', 'label' => __('Program Category', 'yiari'), 'name' => 'program_child_updates_categories', 'type' => 'taxonomy', 'taxonomy' => 'category', 'field_type' => 'checkbox', 'return_format' => 'id', 'allow_null' => 1, 'add_term' => 0, 'save_terms' => 0, 'load_terms' => 0, 'instructions' => __('Pilih satu atau beberapa kategori artikel untuk Cerita Program. Jika kosong, template akan memakai field lama `program_category`.', 'yiari')],
            ['key' => 'field_program_child_updates_count', 'label' => __('Jumlah Artikel Awal', 'yiari'), 'name' => 'program_child_updates_count', 'type' => 'number', 'default_value' => 9, 'min' => 3, 'max' => 18, 'step' => 1],
            ['key' => 'field_program_child_load_more_text', 'label' => __('Teks Tombol Muat Lebih Banyak', 'yiari'), 'name' => 'program_child_load_more_text', 'type' => 'text', 'default_value' => __('Muat Lebih Banyak', 'yiari')],
        ],
    ]);
});
